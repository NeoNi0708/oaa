...
| # | 类型 | 问题 | 状态 |
|---|------|------|------|
| B5 | Bug | 技能页面"已应用"状态不持久 | ✅ 已修复 (2026-05-23) |
| B6 | Bug | 微信安装 wechat-cli 后无响应 | ✅ 已修复 (2026-05-23) |
| B7 | Bug | 桌面端空聊天气泡 | ✅ 已修复 |
| B8 | Bug | 提案自动执行嵌套调用问题 | ✅ 已修复 (2026-05-23) |
| N3 | 能力 | aifix 修复循环移植 | ✅ 已移植 (2026-05-23) |
| N4 | 能力 | 异步代码执行 | ✅ 已移植 (2026-05-23) |
| N5 | 能力 | 文件下载 + GitHub 集成 | ✅ 已移植 (2026-05-23) |
| N6 | 能力 | 模块结构化索引 | ✅ 已移植 (2026-05-23) |
| N7 | 能力 | 自然语言定时任务 — 自动解析+执行+多渠道交付 | ✅ 已实现 (2026-05-23) |
